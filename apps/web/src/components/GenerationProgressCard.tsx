                ...
                >
                  <span
                    className={cn(
                      ...
                      isActive
                        ? 'border-[var(--thread-gold)] bg-[color-mix(in_oklch,var(--thread-gold)_18%,var(--surface-2))] animate-pulse'
                        : isComplete
            ...
            <div className="grid gap-3">
              {shimmerBlocks.map((className, index) => (
                <div
                  ...
                  className={cn(
                    className,
                    'animate-pulse border border-[color-mix(in_oklch,var(--border)_76%,transparent)] bg-[linear-gradient(115deg,var(--surface-2),color-mix(in_oklch,var(--thread-mauve)_16%,var(--surface-3)),var(--surface-2))]',
                  )}
                />
              ))}
            </div>
