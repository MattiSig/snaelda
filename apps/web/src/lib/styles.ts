...
export const text = {
  ...
  appTitle: 'max-w-[13ch] text-[2.25rem] font-black leading-[1.02] text-[var(--paper)] sm:text-[2.7rem]',
  sectionTitle: 'text-[1.35rem] font-black leading-[1.08] text-[var(--paper)] sm:text-[1.55rem]',
...
export const siteCard = {
  list: 'grid gap-1.5',
  card: cn(
    'grid gap-3 rounded-[14px] px-1 py-4 first:pt-1.5',
  ),
...
export const preview = {
  ...
  pageStack: 'grid',
  panel:
    'w-full px-[max(1.25rem,4vw)] py-[clamp(56px,calc(var(--site-section-spacing,96px)*0.75),120px)]',
